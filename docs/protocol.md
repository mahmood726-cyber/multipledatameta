        # Multipledatameta: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood789/Multipledatameta.git

        ## Objective

        MultipleDateMeta provides methods for meta-analysing studies reported at multiple time points, accounting for within-study correlation and follow-up heterogeneity.
        ...
        - Code: https://github.com/mahmood789/Multipledatameta.git
        - Dashboard: https://mahmood789.github.io/Multipledatameta/
